...
process_video() {
    ...
    ffmpeg -nostdin -i "$original_video" -c:v h264_nvenc -b:v "$bitrate" -vf "scale=$resolution" "$output_video"
...
# Set the optional resolution argument, default to 768x432
resolution="${3:-768x432}"
